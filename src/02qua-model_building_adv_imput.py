...
pipeline = Pipeline(steps=[
    ...
    ('self_employed_imputer', self_employed_imputer),
    ('farmer_imputer', farmer_imputer),
    ('employee_imputer', employee_imputer),
    ('retired_farmer_imputer', retired_farmer_imputer),  
    ('retired_self_employed_imputer', retired_self_employed_imputer),
    ('retired_employee_imputer', retired_employee_imputer),
...
joblib.dump(best_model, models_dir / 'adv_imput_model.joblib')
print(f"✓ Model saved to models/adv_imput_model.joblib")